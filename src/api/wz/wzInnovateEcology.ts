...
export function batDelete(data:any) {
    return request({
        url: '/wzInnovateEcology/bat_delete',
        method: 'delete',
        data,
    });
}
...
export function find_list(data:any) {
    return request({
        url: '/wzInnovateEcology/find_list',
        method: 'post',
        data,
    });
}
...
export function find_list_by_page(data:any) {
    return request({
        url: '/wzInnovateEcology/find_list_by_page',
        method: 'post',
        data,
    });
}
