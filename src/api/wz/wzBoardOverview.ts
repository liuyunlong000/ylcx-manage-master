...
export function batDelete(data:any) {
    return request({
        url: '/wzBoardOverview/bat_delete',
        method: 'delete',
        data,
    });
}
...
export function find_list_by_page(data:any) {
    return request({
        url: '/wzBoardOverview/find_list_by_page',
        method: 'post',
        data,
    });
}
