...
export function update_id(data:any) {
    return request({
        url: '/wzScientificDynamic/update',
        method: 'put',
        data,
    });
}
...
export function delete_id(data:any) {
    return request({
        url: '/wzScientificDynamic/delete',
        method: 'delete',
        params: data,
    });
}
...
export function batDelete(data:any) {
    return request({
        url: '/wzScientificDynamic/bat_delete',
        method: 'delete',
        data,
    });
}
...
export function disable_id(data:any) {
    return request({
        url: '/wzScientificDynamic/disable',
        method: 'get',
        params: data
    });
}
