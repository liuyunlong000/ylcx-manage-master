...
export function update_id(data:any) {
    return request({
        url: '/wzInnovatePlateForm/update',
        method: 'put',
        data,
    });
}
...
export function delete_id(data:any) {
    return request({
        url: '/wzInnovatePlateForm/delete',
        method: 'delete',
        params: data,
    });
}
...
export function batDelete(data:any) {
    return request({
        url: '/wzInnovatePlateForm/bat_delete',
        method: 'delete',
        data,
    });
}
...
export function find_id(data:any) {
    return request({
        url: '/wzInnovatePlateForm/find_id',
        method: 'get',
        params: data,
    });
}
...
export function find_list_by_page(data:any) {
    return request({
        url: '/wzInnovatePlateForm/find_list_by_page',
        method: 'post',
        data,
    });
}
...
export function disable_id(data:any) {
    return request({
        url: '/wzInnovatePlateForm/disable',
        method: 'get',
        params: data
    });
}
