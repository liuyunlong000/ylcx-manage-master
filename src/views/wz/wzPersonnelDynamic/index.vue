<template>
    <div>
        ...
        <WzPersonnelDynamicEdit ref="editRef" @fetch-data="fetchData"/>
    </div>
</template>
<script lang="ts">
    export default {
        name: "WzPersonnelDynamicIndex",
        metaDataDict: []
    };
</script>
<script setup lang="ts">
    ...
    import {IWzPersonnelDynamic} from "/@/views/wz/wzPersonnelDynamic/interface/IWzPersonnelDynamic";
    import WzPersonnelDynamicEdit from "/@/views/wz/wzPersonnelDynamic/component/edit.vue";
    import {find_list_by_page, delete_id} from "/@/api/wz/wzPersonnelDynamic";
    ...
    /** 打开编辑弹窗**/
    const openEditDialog = (row: IWzPersonnelDynamic) => {
        editRef.value.openDialog(row.nid);
    };
    /**删除当前行**/
    const handleDelete = (row: IWzPersonnelDynamic) => {
