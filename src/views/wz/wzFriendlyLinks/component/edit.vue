        ...
        <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="100px" @submit.prevent>
            <el-dialog :title="dialogTitle" v-model="isShowDialog" width="1200px" draggable>
                <el-row :gutter="35">
                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item prop="content" label="链接">
                      <el-input v-model.trim="ruleForm.content" placeholder="请输入链接"/>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item prop="type" label="类型">
                      <el-input v-model.trim="ruleForm.type" placeholder="请输入类型"/>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
...
<script setup lang="ts">
    ...
    import {save_id, update_id, find_id} from "/@/api/wz/wzFriendlyLinks";
