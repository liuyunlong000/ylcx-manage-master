<template>
    <div>
        ...
        <WzNoticeEdit ref="editRef" @fetch-data="fetchData"/>
    </div>
</template>
<script lang="ts">
    export default {
...
<script setup lang="ts">
    ...
    import {IWzNotice} from "/@/views/wz/wzNotice/interface/IWzNotice";
    import WzNoticeEdit from "/@/views/wz/wzNotice/component/edit.vue";
    import {find_list_by_page, delete_id} from "/@/api/wz/wzNotice";
    ...
    /** 打开编辑弹窗**/
    const openEditDialog = (row: IWzNotice) => {
        editRef.value.openDialog(row.nid);
    };
    /**删除当前行**/
    const handleDelete = (row: IWzNotice) => {
