<template>
    <div>
        ...
        <WzPersonnelRecruitEdit ref="editRef" @fetch-data="fetchData"/>
    </div>
</template>
<script lang="ts">
    export default {
        name: "WzPersonnelRecruitIndex",
        metaDataDict: []
    };
</script>
<script setup lang="ts">
    ...
    import {IWzPersonnelRecruit} from "/@/views/wz/wzPersonnelRecruit/interface/IWzPersonnelRecruit";
    import WzPersonnelRecruitEdit from "/@/views/wz/wzPersonnelRecruit/component/edit.vue";
    import {find_list_by_page, delete_id} from "/@/api/wz/wzPersonnelRecruit";
    ...
    /** 打开编辑弹窗**/
    const openEditDialog = (row: IWzPersonnelRecruit) => {
        editRef.value.openDialog(row.nid);
    };
    /**删除当前行**/
    const handleDelete = (row: IWzPersonnelRecruit) => {
