<template>
    <div>
        ...
        <WzProductEdit ref="editRef" @fetch-data="fetchData"/>
    </div>
</template>
<script lang="ts">
    export default {
...
<script setup lang="ts">
    ...
    import {IWzProduct} from "/@/views/wz/wzProduct/interface/IWzProduct";
    import WzProductEdit from "/@/views/wz/wzProduct/component/edit.vue";
    import {find_list_by_page, delete_id} from "/@/api/wz/wzProduct";
    ...
    /** 打开编辑弹窗**/
    const openEditDialog = (row: IWzProduct) => {
        editRef.value.openDialog(row.nid);
    };
    /**删除当前行**/
    const handleDelete = (row: IWzProduct) => {
