<template>
    <div>
        ...
        <WzInnovateEdit ref="editRef" @fetch-data="fetchData"/>
    </div>
</template>
<script lang="ts">
    export default {
        name: "WzInnovateIndex",
        metaDataDict: []
    };
</script>
<script setup lang="ts">
    ...
    import {IWzInnovate} from "/@/views/wz/wzInnovate/interface/IWzInnovate";
    import WzInnovateEdit from "/@/views/wz/wzInnovate/component/edit.vue";
    import {find_list_by_page, delete_id} from "/@/api/wz/wzInnovate";
    ...
    /** 打开编辑弹窗**/
    const openEditDialog = (row: IWzInnovate) => {
        editRef.value.openDialog(row.nid);
    };
    /**删除当前行**/
    const handleDelete = (row: IWzInnovate) => {
