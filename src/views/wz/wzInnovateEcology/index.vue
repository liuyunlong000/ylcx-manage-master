<template>
    <div>
        ...
        <WzInnovateEcologyEdit ref="editRef" @fetch-data="fetchData"/>
    </div>
</template>
<script lang="ts">
    export default {
        name: "WzInnovateEcologyIndex",
        metaDataDict: []
    };
</script>
<script setup lang="ts">
    ...
    import {IWzInnovateEcology} from "/@/views/wz/wzInnovateEcology/interface/IWzInnovateEcology";
    import WzInnovateEcologyEdit from "/@/views/wz/wzInnovateEcology/component/edit.vue";
    import {find_list_by_page, delete_id} from "/@/api/wz/wzInnovateEcology";
    ...
    /** 打开编辑弹窗**/
    const openEditDialog = (row: IWzInnovateEcology) => {
        editRef.value.openDialog(row.nid);
    };
    /**删除当前行**/
    const handleDelete = (row: IWzInnovateEcology) => {
