        ...
        <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="100px" @submit.prevent>
            <el-dialog :title="dialogTitle" v-model="isShowDialog" width="1200px" draggable>
                <el-row :gutter="35">
                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item prop="photo" label="图片路径">
                      <el-input v-model.trim="ruleForm.photo" placeholder="请输入图片路径"/>
                    </el-form-item>
                  </el-col>
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item prop="home" label="是否轮播">
                      <el-select v-model.trim="ruleForm.home">
                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item prop="content" label="新闻内容">
                      <el-input :rows="13" type="textarea" v-model.trim="ruleForm.content" placeholder="请输入新闻内容"/>
                    </el-form-item>
                  </el-col>
                </el-row>
				<template #footer>
...
<script setup lang="ts">
    ...
    import {save_id, update_id, find_id} from "/@/api/wz/wzNews";
