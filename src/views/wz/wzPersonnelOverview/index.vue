    ...
    <div>
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" style="text-align: center">
            ...
            <el-table
              ...
              <el-table-column prop="type" label="人才类型" :sortable="false" :sort-orders="['ascending', 'descending']" width="auto" align="center" show-overflow-tooltip/>
...
<script setup lang="ts">
    ...
    import {IWzPersonnelOverview} from "/@/views/wz/wzPersonnelOverview/interface/IWzPersonnelOverview";
    import WzPersonnelOverviewEdit from "/@/views/wz/wzPersonnelOverview/component/edit.vue";
    import {find_list_by_page, delete_id} from "/@/api/wz/wzPersonnelOverview";
    ...
    /** 打开编辑弹窗**/
    const openEditDialog = (row: IWzPersonnelOverview) => {
        editRef.value.openDialog(row.nid);
    };
    /**删除当前行**/
    const handleDelete = (row: IWzPersonnelOverview) => {
