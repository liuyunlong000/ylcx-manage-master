<template>
    <div>
        ...
        <WzScientificDynamicEdit ref="editRef" @fetch-data="fetchData"/>
    </div>
</template>
<script lang="ts">
    export default {
        name: "WzScientificDynamicIndex",
        metaDataDict: []
    };
</script>
<script setup lang="ts">
    ...
    import {IWzScientificDynamic} from "/@/views/wz/wzScientificDynamic/interface/IWzScientificDynamic";
    import WzScientificDynamicEdit from "/@/views/wz/wzScientificDynamic/component/edit.vue";
    import {find_list_by_page, delete_id} from "/@/api/wz/wzScientificDynamic";
    ...
    /** 打开编辑弹窗**/
    const openEditDialog = (row: IWzScientificDynamic) => {
        editRef.value.openDialog(row.nid);
    };
    /**删除当前行**/
    const handleDelete = (row: IWzScientificDynamic) => {
