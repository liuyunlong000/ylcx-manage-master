                ...
                <el-row :gutter="35">
                  ...
                  <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                    <el-form-item prop="content" label="动态内容">
                      <el-input :rows="23" type="textarea" v-model.trim="ruleForm.content" placeholder="请输入动态内容"/>
                    </el-form-item>
                  </el-col>
                </el-row>
				<template #footer>
...
<script setup lang="ts">
    ...
    import {save_id, update_id, find_id} from "/@/api/wz/wzScientificDynamic";
