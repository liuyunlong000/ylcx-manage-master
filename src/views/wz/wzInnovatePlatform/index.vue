<template>
    <div>
        ...
        <WzInnovatePlatformEdit ref="editRef" @fetch-data="fetchData"/>
    </div>
</template>
<script lang="ts">
    export default {
        name: "WzInnovatePlatformIndex",
        metaDataDict: []
    };
</script>
<script setup lang="ts">
    ...
    import {IWzInnovatePlatform} from "/@/views/wz/wzInnovatePlatform/interface/IWzInnovatePlatform";
    import WzInnovatePlatformEdit from "/@/views/wz/wzInnovatePlatform/component/edit.vue";
    import {find_list_by_page, delete_id} from "/@/api/wz/wzInnovatePlatform";
    ...
    /** 打开编辑弹窗**/
    const openEditDialog = (row: IWzInnovatePlatform) => {
        editRef.value.openDialog(row.nid);
    };
    /**删除当前行**/
    const handleDelete = (row: IWzInnovatePlatform) => {
